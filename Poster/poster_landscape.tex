...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{center}
    \includegraphics[width=0.98\linewidth]{images/zscoreplot.eps}
    \end{center}
   ...
   using no prior information except the volumes of tweets recorded in a game. This initial finding leaves room for significant improvement
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \includegraphics[width=\linewidth]{images/croppedsyracusevirginiatsvolume.eps}
   \begin{center}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    model with a labeled training corpus of 4000 tweets and a 
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \paragraph{} Sentiment in this setting is much less meaningful without relating the sentiment
    ...
    \paragraph{} We base classification on the hashtags that were originally used
    ...
    \paragraph{} Tweets that were classified for both teams required tie-breaking, which we 
