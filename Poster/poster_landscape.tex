...
%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \headerbox{Volumes Track Game Events}{name=data,column=0,above=references,below=collection}{
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   \includegraphics[width=\linewidth]{OregonHC_clean_timeseries.pdf}
   \begin{center}
    Tweets per Minute, Oregon vs. Holy Cross
    \end{center}
   }
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    project. To perform classification, we trained a simple bag-of-words
    random forest classifier against a labeled training corpus of 4000 tweets.
    While the classifier ended up treating many tweets as neutral or irrelevant
    because of heterogeneity between the training set and the tweets requiring
    classification, the simple classifier we trained provided adequate classification
    power to test the potential usefulness of the Twitter data. 
    
   }
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Relevance Analysis}{name=relevance,column=1,above=bottom,below=algorithm}{
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    We based on the classification off of the hashtags that were originally used
    ...
    Tweets that were classified for both teams required tie-breaking.

    This led to the following classification procedure:
    \begin{enumerate}
    \item Check for presence of tags and roster names.
    \item If only relevent terms for 1 team, assign that team.
    \item If both, choose team whose term appears first.
    \end{enumerate}
    We also automatically classify tweets with more than 6 hashtags as irrelevant. 
   }
